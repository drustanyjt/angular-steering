MAX_SIM_DIR_ID = {
    "Qwen/Qwen2.5-3B-Instruct": "dir_max_sim_25_mid",
    "Qwen/Qwen2.5-7B-Instruct": "max_sim_19_mid",
    "Qwen/Qwen2.5-14B-Instruct": "max_sim_37_mid",
    "meta-llama/Llama-3.2-3B-Instruct": "max_sim_18_post",
    "meta-llama/Llama-3.1-8B-Instruct": "max_sim_22_mid",
    "google/gemma-2-9b-it": "max_sim_29_mid",
}
