...
def main():
    ...
    steering.load_config_from_file("output/Qwen2.5-7B-Instruct/steering_config-en-max_sim_19_mid-pca_0.npy")
    steering.apply_steering(target_degree=50, adaptive_mode=1)
